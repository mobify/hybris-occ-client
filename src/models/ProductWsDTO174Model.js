...
import PriceRangeWsDTOModel from './PriceRangeWsDTOModel';
...
* @version v2
*/
export default class ProductWsDTO174Model {
    /**
    * Constructs a new <code>ProductWsDTO174Model</code>.
    * @alias module:models/ProductWsDTO174Model
    * @class
    */
    ...
    /**
    * Constructs a <code>ProductWsDTO174Model</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:models/ProductWsDTO174Model} obj Optional instance to populate.
    * @return {module:models/ProductWsDTO174Model} The populated <code>ProductWsDTO174Model</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('productReferences')) {
                obj['productReferences'] = ApiClient.convertToType(data['productReferences'], [ProductReferenceWsDTO173Model]);
            }
            if (data.hasOwnProperty('variantMatrix')) {
                obj['variantMatrix'] = ApiClient.convertToType(data['variantMatrix'], [VariantMatrixElementWsDTOModel]);
            }
            if (data.hasOwnProperty('priceRange')) {
                obj['priceRange'] = PriceRangeWsDTOModel.constructFromObject(data['priceRange']);
            }
    ...
    */
    ...
    /**
    * 
    * @member {Array.<module:models/ProductReferenceWsDTO173Model>} productReferences
    */
    productReferences = undefined;
    /**
    * 
    * @member {Array.<module:models/VariantMatrixElementWsDTOModel>} variantMatrix
    */
    variantMatrix = undefined;
    /**
    * @member {module:models/PriceRangeWsDTOModel} priceRange
    */
