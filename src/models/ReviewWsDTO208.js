...
export default class ReviewWsDTO208 {
    ...
    */
    ...
    /**
    * Constructs a <code>ReviewWsDTO208</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:models/ReviewWsDTO208} obj Optional instance to populate.
    * @return {module:models/ReviewWsDTO208} The populated <code>ReviewWsDTO208</code> instance.
    */
