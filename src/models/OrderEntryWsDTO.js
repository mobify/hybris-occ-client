...
export default class OrderEntryWsDTO {
    ...
    */
    ...
    /**
    * Constructs a <code>OrderEntryWsDTO</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:models/OrderEntryWsDTO} obj Optional instance to populate.
    * @return {module:models/OrderEntryWsDTO} The populated <code>OrderEntryWsDTO</code> instance.
    */
