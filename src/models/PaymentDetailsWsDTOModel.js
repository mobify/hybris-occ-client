...
* @module models/PaymentDetailsWsDTOModel
* @version v2
*/
export default class PaymentDetailsWsDTOModel {
    /**
    * Constructs a new <code>PaymentDetailsWsDTOModel</code>.
    * @alias module:models/PaymentDetailsWsDTOModel
    * @class
    */
    ...
    /**
    * Constructs a <code>PaymentDetailsWsDTOModel</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:models/PaymentDetailsWsDTOModel} obj Optional instance to populate.
    * @return {module:models/PaymentDetailsWsDTOModel} The populated <code>PaymentDetailsWsDTOModel</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('cardType')) {
                obj['cardType'] = CardTypeWsDTOModel.constructFromObject(data['cardType']);
            }
            ...
            if (data.hasOwnProperty('billingAddress')) {
                obj['billingAddress'] = AddressWsDTOModel.constructFromObject(data['billingAddress']);
            }
        }
        return obj;
    }
    ...
    */
    ...
    /**
    * @member {module:models/CardTypeWsDTOModel} cardType
    */
    cardType = undefined;
    /**
    * 
    ...
    */
    ...
    /**
    * @member {module:models/AddressWsDTOModel} billingAddress
    */
