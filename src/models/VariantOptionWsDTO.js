...
export default class VariantOptionWsDTO {
    ...
    */
    ...
    /**
    * Constructs a <code>VariantOptionWsDTO</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:models/VariantOptionWsDTO} obj Optional instance to populate.
    * @return {module:models/VariantOptionWsDTO} The populated <code>VariantOptionWsDTO</code> instance.
    */
    ...
    */
    ...
    /**
    * 
    * @member {Array.<module:models/VariantOptionQualifierWsDTO>} variantOptionQualifiers
    */
