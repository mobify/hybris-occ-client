...
export default class OrderStatusUpdateElementListWsDTO {
    ...
    */
    ...
    /**
    * Constructs a <code>OrderStatusUpdateElementListWsDTO</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:models/OrderStatusUpdateElementListWsDTO} obj Optional instance to populate.
    * @return {module:models/OrderStatusUpdateElementListWsDTO} The populated <code>OrderStatusUpdateElementListWsDTO</code> instance.
    */
    ...
    /**
    * 
    * @member {Array.<module:models/OrderStatusUpdateElementWsDTO>} orderStatusUpdateElements
    */
