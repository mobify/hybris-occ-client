...
export default class ProductWsDTO174 {
    ...
    */
    ...
    /**
    * Constructs a <code>ProductWsDTO174</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:models/ProductWsDTO174} obj Optional instance to populate.
    * @return {module:models/ProductWsDTO174} The populated <code>ProductWsDTO174</code> instance.
    */
