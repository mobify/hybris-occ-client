...
export default class VariantCategoryWsDTO {
    ...
    */
    ...
    /**
    * Constructs a <code>VariantCategoryWsDTO</code> from a plain JavaScript
    ...
    * interest.
    * @param {module:models/VariantCategoryWsDTO} obj Optional instance to
    * populate.
    * @return {module:models/VariantCategoryWsDTO} The populated
    * <code>VariantCategoryWsDTO</code> instance.
    */
