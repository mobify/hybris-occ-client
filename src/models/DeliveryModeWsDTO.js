...
export default class DeliveryModeWsDTO {
    ...
    */
    ...
    /**
    * Constructs a <code>DeliveryModeWsDTO</code> from a plain JavaScript
    ...
    * interest.
    * @param {module:models/DeliveryModeWsDTO} obj Optional instance to
    * populate.
    * @return {module:models/DeliveryModeWsDTO} The populated
    * <code>DeliveryModeWsDTO</code> instance.
    */
