...
export default class PaymentDetailsWsDTO640 {
    ...
    */
    ...
    /**
    * Constructs a <code>PaymentDetailsWsDTO640</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:models/PaymentDetailsWsDTO640} obj Optional instance to populate.
    * @return {module:models/PaymentDetailsWsDTO640} The populated <code>PaymentDetailsWsDTO640</code> instance.
    */
