...
export default class PriceWsDTO {
    ...
    */
    ...
    /**
    * Constructs a <code>PriceWsDTO</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:models/PriceWsDTO} obj Optional instance to populate.
    * @return {module:models/PriceWsDTO} The populated <code>PriceWsDTO</code> instance.
    */
