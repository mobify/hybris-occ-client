...
export default class VoucherWsDTO {
    ...
    */
    ...
    /**
    * Constructs a <code>VoucherWsDTO</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:models/VoucherWsDTO} obj Optional instance to populate.
    * @return {module:models/VoucherWsDTO} The populated <code>VoucherWsDTO</code> instance.
    */
