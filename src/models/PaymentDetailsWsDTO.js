...
export default class PaymentDetailsWsDTO {
    ...
    */
    ...
    /**
    * Constructs a <code>PaymentDetailsWsDTO</code> from a plain JavaScript
    ...
    * interest.
    * @param {module:models/PaymentDetailsWsDTO} obj Optional instance to
    * populate.
    * @return {module:models/PaymentDetailsWsDTO} The populated
    * <code>PaymentDetailsWsDTO</code> instance.
    */
