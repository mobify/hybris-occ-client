...
export default class ProductReferenceWsDTO173 {
    ...
    */
    ...
    /**
    * Constructs a <code>ProductReferenceWsDTO173</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:models/ProductReferenceWsDTO173} obj Optional instance to populate.
    * @return {module:models/ProductReferenceWsDTO173} The populated <code>ProductReferenceWsDTO173</code> instance.
    */
