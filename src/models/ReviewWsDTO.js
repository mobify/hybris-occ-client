...
export default class ReviewWsDTO {
    ...
    */
    ...
    /**
    * Constructs a <code>ReviewWsDTO</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:models/ReviewWsDTO} obj Optional instance to populate.
    * @return {module:models/ReviewWsDTO} The populated <code>ReviewWsDTO</code> instance.
    */
