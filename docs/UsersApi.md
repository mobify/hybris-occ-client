...
[**usersCartsFlagForDeletionByUserId**](UsersApi.md#usersCartsFlagForDeletionByUserId) | **PATCH** /users/{userId}/carts/{cartId}/flagForDeletion | UsersCartsFlagForDeletionByUserId
...
<a name="usersCartsRestoresavedcartByUserId"></a>
...
apiInstance.usersLoginByUserId(userId, opts).then(() => {
  console.log('API called successfully.');
}, (error) => {
  console.error(error);
});
...
<a name="usersOrdersByUserId1"></a>
# **usersOrdersByUserId1**
> OrderHistoryListWsDTOModel usersOrdersByUserId1(userId, opts)
...
apiInstance.usersOrdersByUserId1(userId, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
<a name="usersOrdersByUserId2"></a>
# **usersOrdersByUserId2**
> OrderWsDTOModel usersOrdersByUserId2(userId, cartId, opts)
...
apiInstance.usersOrdersByUserId2(userId, cartId, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
<a name="usersOrdersByUserIdAndCode"></a>
# **usersOrdersByUserIdAndCode**
> OrderWsDTOModel usersOrdersByUserIdAndCode(userId, code, opts)
...
apiInstance.usersOrdersByUserIdAndCode(userId, code, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
<a name="usersPasswordByUserId"></a>
...
apiInstance.usersPasswordByUserId(userId, opts).then(() => {
  console.log('API called successfully.');
}, (error) => {
  console.error(error);
});
...
<a name="usersPaymentdetailsByUserId"></a>
# **usersPaymentdetailsByUserId**
> PaymentDetailsWsDTOModel usersPaymentdetailsByUserId(userId, paymentDetailsId, opts)
...
apiInstance.usersPaymentdetailsByUserId(userId, paymentDetailsId, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
<a name="usersPaymentdetailsByUserId1"></a>
# **usersPaymentdetailsByUserId1**
...
apiInstance.usersPaymentdetailsByUserId1(userId, paymentDetailsId, body).then(() => {
  console.log('API called successfully.');
}, (error) => {
  console.error(error);
});
...
<a name="usersPaymentdetailsByUserId2"></a>
# **usersPaymentdetailsByUserId2**
...
apiInstance.usersPaymentdetailsByUserId2(userId, paymentDetailsId, body).then(() => {
  console.log('API called successfully.');
}, (error) => {
  console.error(error);
});
...
<a name="usersPaymentdetailsByUserId3"></a>
# **usersPaymentdetailsByUserId3**
...
apiInstance.usersPaymentdetailsByUserId3(userId, paymentDetailsId).then(() => {
  console.log('API called successfully.');
}, (error) => {
  console.error(error);
});
...
<a name="usersPaymentdetailsByUserId4"></a>
# **usersPaymentdetailsByUserId4**
> PaymentDetailsListWsDTOModel usersPaymentdetailsByUserId4(userId, opts)
...
apiInstance.usersPaymentdetailsByUserId4(userId, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
