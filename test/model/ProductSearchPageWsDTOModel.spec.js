...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.ProductSearchPageWsDTOModel();
  });
  ...
  describe('ProductSearchPageWsDTOModel', function() {
    it('should create an instance of ProductSearchPageWsDTOModel', function() {
      // uncomment below and update the code to test ProductSearchPageWsDTOModel
      //var instane = new Occ.ProductSearchPageWsDTOModel();
      //expect(instance).to.be.a(Occ.ProductSearchPageWsDTOModel);
    });
