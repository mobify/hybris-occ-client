...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.DeliveryOrderEntryGroupWsDTOModel();
  });
  ...
  describe('DeliveryOrderEntryGroupWsDTOModel', function() {
    it('should create an instance of DeliveryOrderEntryGroupWsDTOModel', function() {
      // uncomment below and update the code to test DeliveryOrderEntryGroupWsDTOModel
      //var instane = new Occ.DeliveryOrderEntryGroupWsDTOModel();
      //expect(instance).to.be.a(Occ.DeliveryOrderEntryGroupWsDTOModel);
    });
