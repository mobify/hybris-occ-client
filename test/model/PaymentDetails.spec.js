...
(function(root, factory) {
    ...
    beforeEach(() => {
        instance = new Occ.PaymentDetails()
    })
    ...
    describe('PaymentDetails', () => {
        it('should create an instance of PaymentDetails', () => {
            // uncomment below and update the code to test PaymentDetails
            // var instane = new Occ.PaymentDetails();
            // expect(instance).to.be.a(Occ.PaymentDetails);
        })
