...
(function(root, factory) {
    ...
    beforeEach(() => {
        instance = new Occ.PaymentDetailsWsDTO()
    })
    ...
    describe('PaymentDetailsWsDTO', () => {
        it('should create an instance of PaymentDetailsWsDTO', () => {
            // uncomment below and update the code to test PaymentDetailsWsDTO
            // var instane = new Occ.PaymentDetailsWsDTO();
            // expect(instance).to.be.a(Occ.PaymentDetailsWsDTO);
        })
        ...
        it('should have the property defaultPayment (base name: "defaultPayment")', () => {
