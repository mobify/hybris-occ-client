...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.PointOfServiceWsDTOModel();
  });
  ...
  describe('PointOfServiceWsDTOModel', function() {
    it('should create an instance of PointOfServiceWsDTOModel', function() {
      // uncomment below and update the code to test PointOfServiceWsDTOModel
      //var instane = new Occ.PointOfServiceWsDTOModel();
      //expect(instance).to.be.a(Occ.PointOfServiceWsDTOModel);
    });
