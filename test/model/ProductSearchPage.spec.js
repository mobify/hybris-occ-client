...
(function(root, factory) {
    ...
    beforeEach(() => {
        instance = new Occ.ProductSearchPage()
    })
    ...
    describe('ProductSearchPage', () => {
        it('should create an instance of ProductSearchPage', () => {
            // uncomment below and update the code to test ProductSearchPage
            // var instane = new Occ.ProductSearchPage();
            // expect(instance).to.be.a(Occ.ProductSearchPage);
        })
