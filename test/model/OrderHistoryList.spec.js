...
(function(root, factory) {
    ...
    beforeEach(() => {
        instance = new Occ.OrderHistoryList()
    })
    ...
    describe('OrderHistoryList', () => {
        it('should create an instance of OrderHistoryList', () => {
            // uncomment below and update the code to test OrderHistoryList
            // var instane = new Occ.OrderHistoryList();
            // expect(instance).to.be.a(Occ.OrderHistoryList);
        })
