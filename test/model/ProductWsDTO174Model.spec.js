...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.ProductWsDTO174Model();
  });
  ...
  describe('ProductWsDTO174Model', function() {
    it('should create an instance of ProductWsDTO174Model', function() {
      // uncomment below and update the code to test ProductWsDTO174Model
      //var instane = new Occ.ProductWsDTO174Model();
      //expect(instance).to.be.a(Occ.ProductWsDTO174Model);
    });
    ...
    it('should have the property productReferences (base name: "productReferences")', function() {
      // uncomment below and update the code to test the property productReferences
      //var instane = new Occ.ProductWsDTO174Model();
      //expect(instance).to.be();
    });

    it('should have the property variantMatrix (base name: "variantMatrix")', function() {
    ...
    it('should have the property multidimensional (base name: "multidimensional")', function() {
