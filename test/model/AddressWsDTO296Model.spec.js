...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.AddressWsDTO296Model();
  });
  ...
  describe('AddressWsDTO296Model', function() {
    it('should create an instance of AddressWsDTO296Model', function() {
      // uncomment below and update the code to test AddressWsDTO296Model
      //var instane = new Occ.AddressWsDTO296Model();
      //expect(instance).to.be.a(Occ.AddressWsDTO296Model);
    });
