...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.PointOfServiceStockWsDTOModel();
  });
  ...
  describe('PointOfServiceStockWsDTOModel', function() {
    it('should create an instance of PointOfServiceStockWsDTOModel', function() {
      // uncomment below and update the code to test PointOfServiceStockWsDTOModel
      //var instane = new Occ.PointOfServiceStockWsDTOModel();
      //expect(instance).to.be.a(Occ.PointOfServiceStockWsDTOModel);
    });

    it('should have the property stockInfo (base name: "stockInfo")', function() {
