...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.ImageWsDTOModel();
  });
  ...
  describe('ImageWsDTOModel', function() {
    it('should create an instance of ImageWsDTOModel', function() {
      // uncomment below and update the code to test ImageWsDTOModel
      //var instane = new Occ.ImageWsDTOModel();
      //expect(instance).to.be.a(Occ.ImageWsDTOModel);
    });
    ...
    it('should have the property galleryIndex (base name: "galleryIndex")', function() {
