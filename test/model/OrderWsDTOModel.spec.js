...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.OrderWsDTOModel();
  });
  ...
  describe('OrderWsDTOModel', function() {
    it('should create an instance of OrderWsDTOModel', function() {
      // uncomment below and update the code to test OrderWsDTOModel
      //var instane = new Occ.OrderWsDTOModel();
      //expect(instance).to.be.a(Occ.OrderWsDTOModel);
    });
