...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.SpecialOpeningDayWsDTOModel();
  });
  ...
  describe('SpecialOpeningDayWsDTOModel', function() {
    it('should create an instance of SpecialOpeningDayWsDTOModel', function() {
      // uncomment below and update the code to test SpecialOpeningDayWsDTOModel
      //var instane = new Occ.SpecialOpeningDayWsDTOModel();
      //expect(instance).to.be.a(Occ.SpecialOpeningDayWsDTOModel);
    });
    ...
    it('should have the property formattedDate (base name: "formattedDate")', function() {
