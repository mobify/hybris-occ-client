...
(function(root, factory) {
    ...
    beforeEach(() => {
        instance = new Occ.PromotionOrderEntryConsumed()
    })
    ...
    describe('PromotionOrderEntryConsumed', () => {
        it('should create an instance of PromotionOrderEntryConsumed', () => {
            // uncomment below and update the code to test PromotionOrderEntryConsumed
            // var instane = new Occ.PromotionOrderEntryConsumed();
            // expect(instance).to.be.a(Occ.PromotionOrderEntryConsumed);
        })
