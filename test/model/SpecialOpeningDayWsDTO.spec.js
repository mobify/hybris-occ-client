...
(function(root, factory) {
    ...
    beforeEach(() => {
        instance = new Occ.SpecialOpeningDayWsDTO()
    })
    ...
    describe('SpecialOpeningDayWsDTO', () => {
        it('should create an instance of SpecialOpeningDayWsDTO', () => {
            // uncomment below and update the code to test SpecialOpeningDayWsDTO
            // var instane = new Occ.SpecialOpeningDayWsDTO();
            // expect(instance).to.be.a(Occ.SpecialOpeningDayWsDTO);
        })
