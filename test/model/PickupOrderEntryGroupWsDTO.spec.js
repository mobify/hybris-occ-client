...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.PickupOrderEntryGroupWsDTO();
  });
  ...
  describe('PickupOrderEntryGroupWsDTO', function() {
    it('should create an instance of PickupOrderEntryGroupWsDTO', function() {
      // uncomment below and update the code to test PickupOrderEntryGroupWsDTO
      //var instane = new Occ.PickupOrderEntryGroupWsDTO();
      //expect(instance).to.be.a(Occ.PickupOrderEntryGroupWsDTO);
    });
