...
(function(root, factory) {
    ...
    beforeEach(() => {
        instance = new Occ.PointOfServiceStock()
    })
    ...
    describe('PointOfServiceStock', () => {
        it('should create an instance of PointOfServiceStock', () => {
            // uncomment below and update the code to test PointOfServiceStock
            // var instane = new Occ.PointOfServiceStock();
            // expect(instance).to.be.a(Occ.PointOfServiceStock);
        })
