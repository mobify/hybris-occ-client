...
(function(root, factory) {
    ...
    beforeEach(() => {
        instance = new Occ.ProductReference()
    })
    ...
    describe('ProductReference', () => {
        it('should create an instance of ProductReference', () => {
            // uncomment below and update the code to test ProductReference
            // var instane = new Occ.ProductReference();
            // expect(instance).to.be.a(Occ.ProductReference);
        })
