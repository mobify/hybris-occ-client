...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.PriceRangeWsDTO();
  });
  ...
  describe('PriceRangeWsDTO', function() {
    it('should create an instance of PriceRangeWsDTO', function() {
      // uncomment below and update the code to test PriceRangeWsDTO
      //var instane = new Occ.PriceRangeWsDTO();
      //expect(instance).to.be.a(Occ.PriceRangeWsDTO);
    });
