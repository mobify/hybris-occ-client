...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.PaymentDetailsWsDTO640Model();
  });
  ...
  describe('PaymentDetailsWsDTO640Model', function() {
    it('should create an instance of PaymentDetailsWsDTO640Model', function() {
      // uncomment below and update the code to test PaymentDetailsWsDTO640Model
      //var instane = new Occ.PaymentDetailsWsDTO640Model();
      //expect(instance).to.be.a(Occ.PaymentDetailsWsDTO640Model);
    });
