...
(function(root, factory) {
  ...
  describe('VoucherWsDTO', function() {
    it('should create an instance of VoucherWsDTO', function() {
      // uncomment below and update the code to test VoucherWsDTO
      //var instane = new Occ.VoucherWsDTO();
      //expect(instance).to.be.a(Occ.VoucherWsDTO);
    });
