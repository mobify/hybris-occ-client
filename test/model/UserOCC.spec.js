...
(function(root, factory) {
    ...
    describe('UserOCC', () => {
        it('should create an instance of UserOCC', () => {
            // uncomment below and update the code to test UserOCC
            // var instane = new Occ.UserOCC();
            // expect(instance).to.be.a(Occ.UserOCC);
        })
