...
(function(root, factory) {
    ...
    beforeEach(() => {
        instance = new Occ.PointOfService()
    })
    ...
    describe('PointOfService', () => {
        it('should create an instance of PointOfService', () => {
            // uncomment below and update the code to test PointOfService
            // var instane = new Occ.PointOfService();
            // expect(instance).to.be.a(Occ.PointOfService);
        })
