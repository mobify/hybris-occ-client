...
(function(root, factory) {
    ...
    describe('DeliveryMode', () => {
        it('should create an instance of DeliveryMode', () => {
            // uncomment below and update the code to test DeliveryMode
            // var instane = new Occ.DeliveryMode();
            // expect(instance).to.be.a(Occ.DeliveryMode);
        })
