...
(function(root, factory) {
    ...
    describe('BaseOption', () => {
        it('should create an instance of BaseOption', () => {
            // uncomment below and update the code to test BaseOption
            // var instane = new Occ.BaseOption();
            // expect(instance).to.be.a(Occ.BaseOption);
        })
