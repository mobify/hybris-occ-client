...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.PriceWsDTOModel();
  });
  ...
  describe('PriceWsDTOModel', function() {
    it('should create an instance of PriceWsDTOModel', function() {
      // uncomment below and update the code to test PriceWsDTOModel
      //var instane = new Occ.PriceWsDTOModel();
      //expect(instance).to.be.a(Occ.PriceWsDTOModel);
    });

    it('should have the property currencyIso (base name: "currencyIso")', function() {
