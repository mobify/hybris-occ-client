...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Occ.ReviewWsDTOModel();
  });
  ...
  describe('ReviewWsDTOModel', function() {
    it('should create an instance of ReviewWsDTOModel', function() {
      // uncomment below and update the code to test ReviewWsDTOModel
      //var instane = new Occ.ReviewWsDTOModel();
      //expect(instance).to.be.a(Occ.ReviewWsDTOModel);
    });
